...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        rockSmall1 = new THREE.Mesh(rockSmall1Geometry, rockMaterial)
        rockSmall1.scale.set(2,2,2)
        rockSmall1.position.set(0, 5, 0)
...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        rockLarge1_1 = new THREE.Mesh(rockLargeGeometry, rockMaterial)
        ...
        rockLarge1_2 = new THREE.Mesh(rockLargeGeometry, rockMaterial)
...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        monkey = new THREE.Mesh(monkeyGeometry, rockMaterial)
